        ...
        <BaseLayout> 
            <Article headerTitle='Technology'>
                ...
                <Artifact>
                    ...
                    <ReferencesBlock
                        handleViewArtifact={() => window.open('https://drive.google.com/file/d/1pHWF-1hcbKSEC7Hf9j-55YJUMdgjafoY/view?usp=sharing', '_blank')}
                    >
                        <Reference>
                ...
                <Artifact>
                    ...
                    <ReferencesBlock
                        handleViewArtifact={() => window.open('https://youtu.be/byErBa6Uhks', '_blank')}
                    >
                        <Reference>
                ...
                <Artifact>
                    ...
                    <ReferencesBlock
                        handleViewArtifact={() => window.open('https://drive.google.com/file/d/1_bD7KJOB7Xbjl6jtJLTbvCx6B1CYUzuj/view?usp=sharing', '_blank')}
                    >
                        <Reference>
