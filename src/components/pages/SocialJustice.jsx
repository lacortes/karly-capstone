        ...
        <BaseLayout> 
            <Article headerTitle='Social Justice & Inclusion'>
                <Artifact>
                    ...
                    <ReferencesBlock
                        handleViewArtifact={() => window.open('https://drive.google.com/file/d/1Mv-LBGTCcs_rBHRD3bX5M6WMjytL_TlU/view?usp=sharing', '_blank')}
                    >
                        <Reference>
                ...
                <Artifact>
                    ...
                    <ReferencesBlock
                        handleViewArtifact={() => window.open('https://docs.google.com/document/d/1zUaFdM54UmDspVkpVJZNK2xql2NflPqC/edit?usp=sharing&ouid=112551125562924414081&rtpof=true&sd=true', '_blank')}
                    >
                        <Reference>
                ...
                <Artifact>
                    ...
                    <ReferencesBlock
                        handleViewArtifact={() => window.open('https://drive.google.com/file/d/11isfHxclAHzMGA6lX9CcuOR_Us-arNJt/view?usp=sharing', '_blank')}
                    >
                        <Reference>
