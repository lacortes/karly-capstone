        ...
        <BaseLayout> 
            <Article headerTitle='Assessment, Evaluation, & Research'>
                ...
                <Artifact>
                    ...
                    <ReferencesBlock
                        handleViewArtifact={() => {
                            window.open('https://docs.google.com/document/d/1U9tv8jdbGgdKnNdn-VN8aB5TPMTJ-b52/edit?usp=sharing&ouid=112551125562924414081&rtpof=true&sd=true', '_blank');
                            window.open('https://docs.google.com/document/d/1HkaqCRrQMsvc_Yu4vRSdVaJnL49SUQRV/edit?usp=sharing&ouid=112551125562924414081&rtpof=true&sd=true', '_blank');
                        }}
                    >
                        <Reference>
                ...
                <Artifact>
                    ...
                    <ReferencesBlock
                        handleViewArtifact={() => window.open('https://drive.google.com/file/d/1NWMIT_rPJSpFUWKqs8SFgvZwoCu749Z4/view?usp=sharing', '_blank')}
                    >
                        <Reference>
                ...
                <Artifact>
                    ...
                    <ReferencesBlock
                        handleViewArtifact={() => window.open('https://drive.google.com/file/d/1u4tyZ7NESXOyELHXUbnqEC9iW3OpCe88/view?usp=sharing', '_blank')}
                    >
                        <Reference>
