        ...
        <BaseLayout> 
            <Article headerTitle='Student Learning & Development'>
                ...
                <Artifact>
                    ...
                    <ReferencesBlock
                        handleViewArtifact={() => window.open('https://docs.google.com/presentation/d/1HYFmn-WI_r_655x1HgKnoUrpWNB7n0B9_kSuJ16PSfg/edit?usp=sharing', '_blank')}
                    >
                        <Reference>
                ...
                <Artifact>
                    ...
                    <ReferencesBlock
                        handleViewArtifact={() => window.open('https://docs.google.com/document/d/16WveF23U9Ea9n7Cp3VNw1P0c2sxVURu0/edit?usp=sharing&ouid=112551125562924414081&rtpof=true&sd=true', '_blank')}
                    >
                        <Reference>
                ...
                <Artifact>
                    ...
                    <ReferencesBlock
                        handleViewArtifact={() => window.open('https://drive.google.com/file/d/1HxuZsJneyzgoZ8DFnQwL7GChGF8AqIRm/view?usp=sharing', '_blank')}
                    >
                        <Reference>
